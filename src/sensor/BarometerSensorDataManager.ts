...
export interface BarometerSensorDataMessage extends BaseSensorDataMessage {
  sensorType: "barometer";
  barometer: number;
  //altitude: number;
}

export interface BarometerSensorDataMessages {
  barometer: BarometerSensorDataMessage;
}
