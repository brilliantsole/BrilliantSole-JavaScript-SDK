  ...
  var e = {
      157: (e, t, n) => {
        ...
        function _(e, t, n, o) {
          ...
          const _ = f.getBestVersionForData(p, n);
          if (!_)
            throw new Error(
          ...
          const v = (function (e, t, n) {
              ...
              const a =
                8 *
                (r.getSymbolTotalCodewords(e) - u.getTotalCodewordsCount(e, t));
              for (
              ...
              return (function (e, t, n) {
                const o = r.getSymbolTotalCodewords(t),
                  i = o - u.getTotalCodewordsCount(t, n),
                  a = u.getBlocksCount(t, n),
                  l = a - (o % a),
                  s = Math.floor(o / a),
                  c = Math.floor(i / a),
                  f = c + 1,
                ...
                let b,
                  ...
                  k = 0;
                for (b = 0; b < v; b++)
                  for (x = 0; x < a; x++) b < m[x].length && (w[k++] = m[x][b]);
                for (b = 0; b < p; b++)
                  for (x = 0; x < a; x++) w[k++] = _[x][b];
                return w;
              })(o, e, t);
            })(t, n, p),
            y = r.getSymbolSize(t),
          ...
          return (
            ...
            isNaN(o) && (o = c.getBestMask(w, m.bind(null, w, n))),
            c.applyMask(o, w),
            m(w, n, o),
            {
              modules: w,
      ...
      172: (e, t, n) => {
        ...
        function C(e) {
          ((!e.__d && (e.__d = !0) && l.push(e) && !A.__r++) ||
            ...
            ((s = o.debounceRendering) || c)(A);
        }
        function A() {
          for (var e, t, n, r, i, a, s, c = 1; l.length; )
            l.length > c && l.sort(u),
              (e = l.shift()),
              (c = l.length),
              e.__d &&
        ...
        function j(e, t, n, r, o, i, a, l, s, c, u) {
          var d,
            f,
            p,
            h,
            ...
            w = (r && r.__k) || _,
            b = t.length;
          for (s = N(n, t, w, s, b), d = 0; d < b; d++)
            null != (p = n.__k[d]) &&
              ((f = -1 == p.__i ? m : w[p.__i] || m),
              (p.__i = d),
              (v = D(e, p, f, o, i, a, l, s, c, u)),
              (h = p.__e),
              p.ref &&
                f.ref != p.ref &&
                (f.ref && V(f.ref, null, p), u.push(p.ref, p.__c || h, p)),
              null == g && null != h && (g = h),
            ...
            "function" != typeof a
              ? ("string" == typeof a ||
                ...
                a.constructor == String
                  ? (a = e.__k[i] = k(null, a, null, null, null))
                  : y(a)
                  ? (a = e.__k[i] = k(P, { children: a }, null, null, null))
                  : null == a.constructor && a.__b > 0
                  ? (a = e.__k[i] =
                      k(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v))
                  : (e.__k[i] = a),
                (s = i + f),
                (a.__ = e),
                (a.__b = e.__b + 1),
        ...
        function I(e, t, n, r) {
          var o,
            ...
            c = t[n],
            u = null != c && !(2 & c.__u);
          if ((null === c && null == l) || (u && l == c.key && s == c.type))
            return n;
          if (r > (u ? 1 : 0))
        ...
        function D(e, t, n, r, i, a, l, s, c, u) {
          var d,
            f,
            p,
            h,
          ...
          e: if ("function" == typeof L)
            try {
              if (
                ...
                (k = (d = L.contextType) && r[d.__c]),
                (M = d ? (k ? k.props.value : d.__) : r),
                n.__c
                ...
                x &&
                  ...
                  (f.__s == f.state && (f.__s = w({}, f.__s)),
                  w(f.__s, L.getDerivedStateFromProps(v, f.__s))),
                (h = f.props),
                (g = f.state),
                (f.__v = t),
                p)
                ...
                if (
                  ...
                  t.__v == n.__v ||
                    (!f.__e &&
                      ...
                      !1 === f.shouldComponentUpdate(v, f.__s, M)))
                ) {
                  for (
                    t.__v != n.__v &&
                ...
                null != f.componentWillUpdate &&
                  f.componentWillUpdate(v, f.__s, M),
                  x &&
                    null != f.componentDidUpdate &&
                    f.__h.push(function () {
                      f.componentDidUpdate(h, g, m);
                    });
              }
              if (
                ((f.context = M),
              ...
              (f.state = f.__s),
                null != f.getChildContext &&
                  (r = w(w({}, r), f.getChildContext())),
                x &&
                  !p &&
                  null != f.getSnapshotBeforeUpdate &&
                  (m = f.getSnapshotBeforeUpdate(h, g)),
                (N = d),
                null != d &&
                  d.type === P &&
                  null == d.key &&
                  (N = H(d.props.children)),
                (s = j(e, y(N) ? N : [N], t, n, r, i, a, l, s, c, u)),
                (f.base = t.__e),
                (t.__u &= -161),
            ...
            null == a && t.__v == n.__v
              ...
              : (s = t.__e = F(n.__e, t, n, r, i, a, l, c, u));
        ...
        function F(e, t, n, i, a, l, s, c, u) {
          ...
          if (null == e) {
            ...
            (e = document.createElementNS(a, k, x.is && x)),
              c && (o.__m && o.__m(t, l), (c = !1)),
              (l = null);
          }
          if (null == k) w === x || (c && e.data == x) || (e.data = x);
          else {
            if (((l = l && r.call(e.childNodes)), !c && null != l))
        ...
        function q(e, t, n) {
          ...
          n || b(e.__e), (e.__c = e.__ = e.__e = void 0);
        }
        function Y(e, t, n) {
        ...
        function X(e, t, n) {
          ...
          return (
            ...
            k(e.type, s, o || e.key, i || e.ref, null)
          );
        }
        function K(e) {
          function t(e) {
      ...
      253: (e, t, n) => {
        ...
        t.ModelScene = function (e) {
          ...
          return (
            ...
            (0, i.useEffect)(
              function () {
                f.current.setOrbitInteraction(c);
              },
              [c]
            ),
            (0, i.useEffect)(
              function () {
                f.current.setEnvMap(l.defaultMaps[u] || u);
              },
              [u]
            ),
      ...
      638: (e, t, n) => {
        ...
        (m.styleTagTransform = h()),
          ...
          o()(g.A, m);
        const _ = g.A && g.A.locals ? g.A.locals : void 0;
      },
      791: (e) => {
        function t(n) {
          return (
            ...
            update: function () {
              (0, a.configure)(
                c(
                  ...
                  {},
                  {
                    mediaSrc: u(this.data.mediaSrc),
                    logoSrc: u(this.data.logoSrc),
                    backgroundSrc: u(this.data.backgroundSrc),
                    sceneEnvMap: u(this.data.sceneEnvMap),
                  }
                )
              );
            },
      ...
      2148: (e, t, n) => {
        ...
        t.createScene = function (e) {
          ...
          var c = new t.AmbientLight(12303291);
          (c.intensity = 1), a.add(c);
          var u = new t.DirectionalLight(16777215);
          u.position.set(-0.5, 1, 1).normalize(), (u.intensity = 0.6), a.add(u);
          ...
          return (
            ...
            k(m),
            {
              ...
              setLightingIntensity: function (e) {
                (c.intensity = 1 * e), (u.intensity = 0.6 * e);
              },
      ...
      2296: (e, t, n) => {
        ...
        t.normalizeParameters = function (e) {
          return a(
            ...
            {},
            {
              sceneOrbitIdle: c(l, e.sceneOrbitIdle),
              sceneOrbitInteraction: c(s, e.sceneOrbitInteraction),
      ...
      3843: (e, t, n) => {
        ...
        o.push([
          e.id,
          '@font-face{font-family:"Nunito";src:url("./external/xrextras-shared-resources/fonts/Nunito-Regular.woff") format("woff"),url("./external/xrextras-shared-resources/fonts/Nunito-Regular.ttf") format("truetype")}@font-face{font-family:"Nunito-SemiBold";src:url("./external/xrextras-shared-resources/fonts/Nunito-SemiBold.woff") format("woff"),url("./external/xrextras-shared-resources/fonts/Nunito-SemiBold.ttf") format("truetype")}',
          "",
        ]);
        const i = o;
      },
      ...
      5994: (e, t, n) => {
        ...
        function w(e, t) {
          var n = _(r++, 3);
          !u.__s && I(n.__H, t) && ((n.__ = e), (n.u = t), o.__H.__h.push(n));
        }
        function b(e, t) {
          var n = _(r++, 4);
          !u.__s && I(n.__H, t) && ((n.__ = e), (n.u = t), o.__h.push(n));
        }
        function x(e) {
          return (
            (s = 5),
        ...
        function M(e, t) {
          var n = _(r++, 7);
          return I(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__;
        }
        function P(e, t) {
          return (
            (s = 8),
        ...
        function A() {
          for (var e; (e = c.shift()); )
            if (e.__P && e.__H)
              try {
                e.__H.__h.forEach(T), e.__H.__h.forEach(L), (e.__H.__h = []);
              } catch (t) {
          ...
          (u.__r = function (e) {
            ...
            t &&
              (i === o
                ...
                : (t.__h.forEach(T), t.__h.forEach(L), (t.__h = []), (r = 0))),
              (i = o);
          }),
          (u.diffed = function (e) {
            p && p(e);
            ...
            t &&
              t.__H &&
              (t.__H.__h.length &&
                ((1 !== c.push(t) && a === u.requestAnimationFrame) ||
                  ((a = u.requestAnimationFrame) || N)(A)),
          ...
          s =
            ((t.showAlmostThere = function (e, t) {
              ...
              for (
                ...
                s[c].textContent = r;
              var u = XR8.XrDevice.incompatibleReasons(e),
                d = XR8.XrDevice.incompatibleReasonDetails(e),
                f = XR8.XrDevice.deviceEstimate(),
                p = document.querySelector('meta[property="og:image"]'),
                h = p && p.content;
              ...
              var g = document.getElementById("error_copy_link_btn");
              if (
                (g.addEventListener("click", function () {
                  ...
                  document.body.appendChild(e),
                    ...
                    (g.innerHTML = "Copied!"),
                    g.classList.add("error-copy-link-copied");
                }),
                u.includes(
                ...
                if ("Safari" === d.inAppBrowserType)
                  ...
                  switch (d.inAppBrowser) {
                    ...
                    case "Snapchat":
                      a("error_msg_open_in_safari"),
                        a("error_text_header_top"),
                        a("top_corner_open_safari"),
                    ...
                    case "Naver":
                      a("error_msg_open_in_safari"),
                        a("error_text_header_bottom"),
                        a("bottom_corner_open_safari");
                      break;
                    case "Line":
                    case "Mozilla Firefox Focus":
                      a("error_msg_open_in_safari"),
                        a("error_text_header_top"),
                        a("top_close_open_safari");
                      break;
                    default:
                      a("error_unknown_webview");
                  }
                return !0;
              }
              if (
                ...
                if ("iOS" === f.os) return a("error_msg_web_assembly_ios"), !0;
                if ("Android" === f.os)
                  return a("error_msg_web_assembly_android"), !0;
              }
              return "iOS" === f.os
                ? (a("error_unknown_webview"),
                  a("error_text_header_unknown"),
                  !0)
                : "Android" === f.os &&
                    (a("error_msg_android_almost_there"),
                    "Huawei" === f.manufacturer
                      ? a("error_msg_detail_huawei_almost_there")
                      : a("error_msg_detail_android_almost_there"),
                    !0);
            }),
            !1);
                ...
                for (let s = 0; s < e.length; s++) {
                  ...
                  c || a || (a = !0),
                    e[s]
                      ? (l++,
                        (s > 0 && c > 0 && e[s - 1]) ||
                          ((r += a ? i("M", c + n, 0.5 + u + n) : i("m", o, 0)),
                          (o = 0),
                          (a = !1)),
                        (c + 1 < t && e[s + 1]) || ((r += i("h", l)), (l = 0)))
                      : o++;
                }
                return r;
              })(s, l, a.margin) +
          ...
          return (
            ...
            s.h(
              ...
              s.h(
                ...
                u && s.h(f.FacebookMessengerButton, { url: t }),
                u ? o : n,
                " ",
      ...
      6943: (e, t, n) => {
        ...
        t.MediaVideo = function (e) {
          var t = e.src,
            ...
            v = _[0],
            y = _[1],
            w = (0, s.useElementSize)(u),
            b = (0, s.useElementSize)(d),
            x =
              w && b
                ? {
                    "--landing8-video-center-x": "".concat(w.width / 2, "px"),
                    "--landing8-video-center-y": "".concat(b.height / 2, "px"),
          ...
          return a.h(
            "div",
            { ref: u, className: "landing8-media-video-container", style: x },
            "minimal" === o &&
              a.h(
                a.Fragment,
                null,
                v
                  ...
                  : a.h(
                      ...
                      a.h("img", {
                        alt: "Play",
                        src: "./external/landing-page/resources/img/mediarecorder/play-v1.svg",
                  ...
                  "button",
                  {
                    ...
                    className:
                      "landing8-media-control-button landing8-media-mute-button landing8-shadow ".concat(
                        !h && v ? "landing8-playing-with-sound" : ""
                      ),
                  },
                  h
                    ? a.h("img", {
                        alt: "Unmute",
                        src: "./external/xrextras-shared-resources/img/mediarecorder/sound-off-v1.svg",
                        className: "landing8-media-control-icon",
                      })
                    : a.h("img", {
                        alt: "Mute",
                        src: "./external/xrextras-shared-resources/img/mediarecorder/sound-on-v1.svg",
                        className: "landing8-media-control-icon",
                      })
                )
              ),
            a.h("video", {
              ...
              onCanPlayThrough: function (e) {
                ...
                n(t), g(d.current.muted), y(!d.current.paused);
              },
              onError: c,
              onPlay: function () {
                return y(!0);
          ...
          (t.pipelineModule = function () {
            return {
              ...
              onException: function () {
                if (!XR8.XrDevice.isDeviceBrowserCompatible(u)) {
              ...
              onRemove: function () {
                (u = null), (0, l.hide)(), (0, s.hideAlmostThere)();
              },
            };
          });
      },
      ...
      8214: (e, t, n) => {
        ...
        t.View = function (e) {
          ...
          return !e.mediaSrc || r
            ...
            : l.h(c.MediaView, (0, i.default)({}, e, { onError: f }));
        };
      },
      8390: (e, t, n) => {
        "use strict";
        ...
        t.UrlPromptLink = function (e) {
          ...
          return a.h(
            ...
            a.h("span", { className: "landing8-prompt-link-placeholder" }, c),
            a.h(
              "span",
              {
              ...
              i = (function (e, t) {
                ...
                for (let a = 0; a < e.length; a++) {
                  ...
                  for (let e = 0; e < l.length; e++) {
                    const c = l[e],
                      u = "" + a + e;
                    s.push(u), (n[u] = { node: c, lastCount: 0 }), (o[u] = {});
                    for (let e = 0; e < i.length; e++) {
                      const a = i[e];
                      n[a] && n[a].node.mode === c.mode
                        ? ((o[a][u] =
                            h(n[a].lastCount + c.length, c.mode) -
                            h(n[a].lastCount, c.mode)),
