...
export declare const ClientEventTypes: readonly ["notConnected", "connecting", "connected", "disconnecting", "connectionStatus", "isConnected", "isScanningAvailable", "isScanning", "discoveredDevice", "expiredDiscoveredDevice", "discoveredDevices", "scanningAvailable", "scanningNotAvailable", "scanning", "notScanning"];
...
declare abstract class BaseClient {
    ...
    get addEventListener(): <T extends "discoveredDevice" | "expiredDiscoveredDevice" | "discoveredDevices" | "isScanningAvailable" | "isScanning" | "scanning" | "notScanning" | "scanningAvailable" | "scanningNotAvailable" | "*" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<BaseClient, "discoveredDevice" | "expiredDiscoveredDevice" | "discoveredDevices" | "isScanningAvailable" | "isScanning" | "scanning" | "notScanning" | "scanningAvailable" | "scanningNotAvailable" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected", ClientEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    ...
    get waitForEvent(): <T extends "discoveredDevice" | "expiredDiscoveredDevice" | "discoveredDevices" | "isScanningAvailable" | "isScanning" | "scanning" | "notScanning" | "scanningAvailable" | "scanningNotAvailable" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<import("../utils/EventDispatcher.ts").ListenerEvent<BaseClient, "discoveredDevice" | "expiredDiscoveredDevice" | "discoveredDevices" | "isScanningAvailable" | "isScanning" | "scanning" | "notScanning" | "scanningAvailable" | "scanningNotAvailable" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected", ClientEventMessages, T>>;
