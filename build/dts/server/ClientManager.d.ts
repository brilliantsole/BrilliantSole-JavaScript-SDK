...
declare class ClientManager {
    ...
    constructor();
    get clients(): Client[];
    get addEventListener(): <T extends "*" | "client" | "client*" | "clientIsConnected" | "clientNotConnected" | "clientConnecting" | "clientConnected" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientExpiredDiscoveredDevice" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "clients">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ClientManager, "client" | "client*" | "clientIsConnected" | "clientNotConnected" | "clientConnecting" | "clientConnected" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientExpiredDiscoveredDevice" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "clients", ClientManagerEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
