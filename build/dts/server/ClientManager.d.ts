...
export declare const ClientManagerEventTypes: readonly [...("clientDiscoveredDevice" | "clientExpiredDiscoveredDevice" | "clientIsScanningAvailable" | "clientIsScanning" | "clientScanning" | "clientNotScanning" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientNotConnected" | "clientConnecting" | "clientConnected" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsConnected")[], "client", "clients", "client*"];
...
declare class ClientManager {
    ...
    constructor();
    get clients(): Client[];
    get addEventListener(): <T extends "*" | "client" | "clientDiscoveredDevice" | "clientExpiredDiscoveredDevice" | "clientIsScanningAvailable" | "clientIsScanning" | "clientScanning" | "clientNotScanning" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientNotConnected" | "clientConnecting" | "clientConnected" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsConnected" | "clients" | "client*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ClientManager, "client" | "clientDiscoveredDevice" | "clientExpiredDiscoveredDevice" | "clientIsScanningAvailable" | "clientIsScanning" | "clientScanning" | "clientNotScanning" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientNotConnected" | "clientConnecting" | "clientConnected" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsConnected" | "clients" | "client*", ClientManagerEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
