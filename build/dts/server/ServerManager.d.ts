...
declare class ServerManager {
    ...
    get addEventListener(): <T extends "*" | "server" | "serverClientConnected" | "serverClientNotConnected" | "server*" | "servers">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "serverClientConnected" | "serverClientNotConnected" | "server*" | "servers", ServerManagerEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "server" | "serverClientConnected" | "serverClientNotConnected" | "server*" | "servers">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "serverClientConnected" | "serverClientNotConnected" | "server*" | "servers", ServerManagerEventMessages, T>) => void) => void;
