...
declare class ScannerManager {
    ...
    get addEventListener(): <T extends "*" | "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanner*" | "scanners">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ScannerManager, "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanner*" | "scanners", ScannerManagerEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanner*" | "scanners">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ScannerManager, "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanner*" | "scanners", ScannerManagerEventMessages, T>) => void) => void;
