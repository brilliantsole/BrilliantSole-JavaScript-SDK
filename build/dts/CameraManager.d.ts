...
export declare const CameraCommands: readonly ["takePicture", "takePictures", "stop", "sleep", "wake"];
export type CameraCommand = (typeof CameraCommands)[number];
export declare const CameraStatuses: readonly ["idle", "takingPicture", "takingPictures", "asleep"];
