...
declare class Device {
    ...
    get setDisplayColor(): (colorIndex: number, color: import("./BS.ts").DisplayColorRGBOrString, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplaySegmentStartCap(): (segmentStartCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get setDisplaySegmentEndCap(): (segmentEndCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get setDisplaySegmentCap(): (segmentCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplayCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplayRotationCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get drawDisplayPolygon(): (points: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayWireframe(): (wireframe: import("./DisplayManager.ts").DisplayWireframe, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get drawDisplaySegments(): (points: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get drawDisplayBitmap(): (offsetX: number, offsetY: number, bitmap: import("./DisplayManager.ts").DisplayBitmap, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get selectDisplayBitmapColors(): (bitmapColorPairs: import("./DisplayManager.ts").DisplayBitmapColorPair[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplayBitmapScaleDirection(): (direction: import("./utils/DisplayUtils.ts").DisplayScaleDirection, bitmapScale: number, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get selectDisplaySpriteColors(): (spriteColorPairs: import("./DisplayManager.ts").DisplaySpriteColorPair[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplaySpriteScaleDirection(): (direction: import("./utils/DisplayUtils.ts").DisplayScaleDirection, spriteScale: number, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get setDisplayAlignment(): (alignmentDirection: import("./utils/DisplayContextState.ts").DisplayAlignmentDirection, alignment: import("./BS.ts").DisplayAlignment, sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    ...
    get drawDisplayQuadraticBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayQuadraticBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
    get drawDisplayClosedPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean, isSending?: boolean) => Promise<void>;
