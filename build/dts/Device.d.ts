...
import BaseConnectionManager, { ConnectionStatus, ConnectionMessageType } from "./connection/BaseConnectionManager";
import { SensorConfiguration, SensorConfigurationEventMessages } from "./sensor/SensorConfigurationManager";
import { SensorDataEventMessages, SensorType } from "./sensor/SensorDataManager";
import { VibrationConfiguration } from "./vibration/VibrationManager";
import { FileTransferEventMessages, FileType } from "./FileTransferManager";
import { TfliteEventMessages } from "./TfliteManager";
import { FirmwareEventMessages } from "./FirmwareManager";
import { DeviceInformationEventMessages } from "./DeviceInformationManager";
import { DeviceType, InformationEventMessages } from "./InformationManager";
...
declare class Device {
    ...
    get deviceInformation(): import("./DeviceInformationManager").DeviceInformation;
    ...
    get setTfliteTask(): (newTask: import("./TfliteManager").TfliteTask, sendImmediately?: boolean) => Promise<void>;
    ...
    get firmwareImages(): import("./FirmwareManager").FirmwareImage[];
