...
declare class Device {
    ...
    get setDisplayColor(): (colorIndex: number, color: import("./DisplayManager.ts").DisplayColorRGB | string, sendImmediately?: boolean) => void;
    ...
    get setDisplaySegmentStartCap(): (segmentStartCap: import("./DisplayManager.ts").DisplaySegmentCap, sendImmediately?: boolean) => void;
    get setDisplaySegmentEndCap(): (segmentEndCap: import("./DisplayManager.ts").DisplaySegmentCap, sendImmediately?: boolean) => void;
    get setDisplaySegmentCap(): (segmentCap: import("./DisplayManager.ts").DisplaySegmentCap, sendImmediately?: boolean) => void;
    ...
    get setDisplayCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean) => void;
    ...
    get setDisplayRotationCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean) => void;
    ...
    get setDisplayContextState(): (newState: import("./DisplayManager.ts").PartialDisplayContextState) => Promise<void>;
}
