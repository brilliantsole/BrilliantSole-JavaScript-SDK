...
declare class Device {
    ...
    get setDisplayColor(): (colorIndex: number, color: import("./BS.ts").DisplayColorRGBOrString, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplaySegmentStartCap(): (segmentStartCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplaySegmentEndCap(): (segmentEndCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplaySegmentCap(): (segmentCap: import("./BS.ts").DisplaySegmentCap, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplayCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplayRotationCrop(): (cropDirection: import("./utils/DisplayUtils.ts").DisplayCropDirection, crop: number, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get drawDisplayPolygon(): (points: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayWireframe(): (wireframe: import("./DisplayManager.ts").DisplayWireframe, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get drawDisplaySegments(): (points: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get drawDisplayBitmap(): (offsetX: number, offsetY: number, bitmap: import("./DisplayManager.ts").DisplayBitmap, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get selectDisplayBitmapColors(): (bitmapColorPairs: import("./DisplayManager.ts").DisplayBitmapColorPair[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplayBitmapColor(): (bitmapColorIndex: number, color: import("./BS.ts").DisplayColorRGBOrString, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplayBitmapScaleDirection(): (direction: import("./utils/DisplayUtils.ts").DisplayScaleDirection, bitmapScale: number, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get selectDisplaySpriteColors(): (spriteColorPairs: import("./DisplayManager.ts").DisplaySpriteColorPair[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplaySpriteColor(): (spriteColorIndex: number, color: import("./BS.ts").DisplayColorRGBOrString, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplaySpriteScaleDirection(): (direction: import("./utils/DisplayUtils.ts").DisplayScaleDirection, spriteScale: number, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplayAlignment(): (alignmentDirection: import("./utils/DisplayContextState.ts").DisplayAlignmentDirection, alignment: import("./BS.ts").DisplayAlignment, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplayVerticalAlignment(): (verticalAlignment: import("./BS.ts").DisplayAlignment, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplayHorizontalAlignment(): (horizontalAlignment: import("./BS.ts").DisplayAlignment, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get resetDisplayAlignment(): (sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplaySpritesDirection(): (spritesDirection: import("./BS.ts").DisplayDirection, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get setDisplaySpritesLineDirection(): (spritesLineDirection: import("./BS.ts").DisplayDirection, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    ...
    get setDisplaySpritesAlignment(): (spritesAlignment: import("./BS.ts").DisplayAlignment, sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayQuadraticBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayQuadraticBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
    get drawDisplayClosedPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean, isParsing?: boolean) => Promise<void>;
