...
declare class Device {
    ...
    get drawDisplayPolygon(): (points: import("./BS.ts").Vector2[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayWireframe(): (wireframe: import("./DisplayManager.ts").DisplayWireframe, sendImmediately?: boolean) => Promise<void>;
    ...
    get drawDisplayQuadraticBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayQuadraticBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurve(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayCubicBezierCurves(): (controlPoints: import("./BS.ts").Vector2[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean) => Promise<void>;
    get drawDisplayClosedPath(): (curves: import("./DisplayManager.ts").DisplayBezierCurve[], sendImmediately?: boolean) => Promise<void>;
