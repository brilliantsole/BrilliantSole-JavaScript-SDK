...
export declare const MicrophoneCommands: readonly ["start", "stop"];
export type MicrophoneCommand = (typeof MicrophoneCommands)[number];
export declare const MicrophoneStatuses: readonly ["idle", "streaming"];
...
declare class MicrophoneManager {
    ...
    parseMessage(messageType: MicrophoneMessageType, dataView: DataView): void;
