...
declare class FileTransferManager {
    ...
    get addEventListener(): <T extends "maxFileLength" | "getFileType" | "getFileLength" | "getFileChecksum" | "fileTransferStatus" | "getFileBlock" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "setFileType" | "setFileLength" | "setFileChecksum" | "setFileTransferCommand" | "setFileBlock" | "fileBytesTransferred">(type: T, listener: (event: {
        type: T;
        target: Device;
    ...
    get removeEventListener(): <T extends "maxFileLength" | "getFileType" | "getFileLength" | "getFileChecksum" | "fileTransferStatus" | "getFileBlock" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "setFileType" | "setFileLength" | "setFileChecksum" | "setFileTransferCommand" | "setFileBlock" | "fileBytesTransferred">(type: T, listener: (event: {
        type: T;
        target: Device;
        message: FileTransferEventMessages[T];
    }) => void) => void;
    get waitForEvent(): <T extends "maxFileLength" | "getFileType" | "getFileLength" | "getFileChecksum" | "fileTransferStatus" | "getFileBlock" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "setFileType" | "setFileLength" | "setFileChecksum" | "setFileTransferCommand" | "setFileBlock" | "fileBytesTransferred">(type: T) => Promise<{
        type: T;
        target: Device;
        message: FileTransferEventMessages[T];
    }>;
