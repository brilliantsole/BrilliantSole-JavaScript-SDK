...
export declare function parseRotation(formattedRotation: number, isRadians?: boolean, isSigned?: boolean): number;
...
export declare function formatScale(scale: number): number;
export declare function parseScale(scale: number): number;
export declare function roundScale(scale: number): number;
...
export declare const maxNumberOfDisplayCurvePoints = 200;
...
export declare function getNumberOfConrolPoints(curveType: DisplayBezierCurveType, isPath?: boolean): number;
