...
export declare function selectSpriteSheetPalette(displayManagerInterface: DisplayManagerInterface, paletteName: string, offset?: number, indicesOnly?: boolean, sendImmediately?: boolean): Promise<void>;
