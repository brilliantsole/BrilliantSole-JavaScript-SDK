...
export declare const ShowDisplayContextCommandTypes: readonly ["show", "clear", "setColor", "setColorOpacity"];
export type ShowDisplayContextCommandType = (typeof ShowDisplayContextCommandTypes)[number];
...
export declare function serializeDisplayContextCommandData(displayManager: DisplayManagerInterface, command: DisplayContextCommand): DataView<ArrayBuffer> | undefined;
export declare function serializeDisplayContextCommand(displayManager: DisplayManagerInterface, command: DisplayContextCommand): ArrayBuffer | undefined;
export declare function serializeDisplayContextCommands(displayManager: DisplayManagerInterface, commands: DisplayContextCommand[]): ArrayBuffer;
export declare function parseDisplayContextCommands(displayManager: DisplayManagerInterface, dataView: DataView): DisplayContextCommand[];
declare const SpritesDisplayContextCommandTypes: readonly ["selectSpriteColor", "selectSpriteColors", "resetSpriteColors", "setSpriteScaleX", "setSpriteScaleY", "setSpriteScale", "resetSpriteScale", "setSpritesLineHeight", "setSpritesDirection", "setSpritesLineDirection", "setSpritesSpacing", "setSpritesLineSpacing", "setSpritesAlignment", "setSpritesLineAlignment", "selectSpriteSheet"];
export type SpritesDisplayContextCommandType = (typeof SpritesDisplayContextCommandTypes)[number];
declare const PathDrawDisplayContextCommandTypes: readonly ["drawSegment", "drawSegments", "drawQuadraticBezierCurve", "drawQuadraticBezierCurves", "drawCubicBezierCurve", "drawCubicBezierCurves", "drawPath", "drawWireframe"];
export type PathDrawDisplayContextCommandType = (typeof PathDrawDisplayContextCommandTypes)[number];
declare const PathStateDisplayContextCommandTypes: readonly ["setSegmentRadius", "setSegmentEndRadius", "setSegmentStartRadius", "setSegmentCap", "setSegmentStartCap", "setSegmentEndCap"];
export type PathStateDisplayContextCommandType = (typeof PathStateDisplayContextCommandTypes)[number];
