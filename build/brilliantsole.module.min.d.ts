...
declare class DisplayCanvasHelper implements DisplayManagerInterface {
    #private;
    constructor();
    get addEventListener(): <T extends "resize" | "brightness" | "deviceConnected" | "deviceIsConnected" | "device" | "deviceNotConnected" | "numberOfColors" | "color" | "contextState" | "colorOpacity" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T, listener: (event: {
        type: T;
    ...
    get removeEventListener(): <T extends "resize" | "brightness" | "deviceConnected" | "deviceIsConnected" | "device" | "deviceNotConnected" | "numberOfColors" | "color" | "contextState" | "colorOpacity" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T, listener: (event: {
        type: T;
        target: DisplayCanvasHelper;
        message: DisplayCanvasHelperEventMessages[T];
    }) => void) => void;
    get waitForEvent(): <T extends "resize" | "brightness" | "deviceConnected" | "deviceIsConnected" | "device" | "deviceNotConnected" | "numberOfColors" | "color" | "contextState" | "colorOpacity" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T) => Promise<{
        type: T;
        target: DisplayCanvasHelper;
        message: DisplayCanvasHelperEventMessages[T];
    }>;
