...
declare class DeviceManager {
    ...
    get AddEventListener(): <T extends "deviceConnected" | "deviceIsConnected" | "deviceDisconnected" | "availableDevices" | "connectedDevices">(type: T, listener: (event: {
        type: T;
    ...
    get RemoveEventListener(): <T extends "deviceConnected" | "deviceIsConnected" | "deviceDisconnected" | "availableDevices" | "connectedDevices">(type: T, listener: (event: {
        type: T;
        target: DeviceManager;
        message: DeviceManagerEventMessages[T];
    }) => void) => void;
    get RemoveEventListeners(): <T extends "deviceConnected" | "deviceIsConnected" | "deviceDisconnected" | "availableDevices" | "connectedDevices">(type: T) => void;
    get RemoveAllEventListeners(): () => void;
