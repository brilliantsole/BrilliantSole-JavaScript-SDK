...
interface DisplayManagerInterface {
    ...
    setColor(colorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean): Promise<void>;
    ...
    setBitmapColor(bitmapColorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean): Promise<void>;
    ...
    setSpriteColor(spriteColorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean): Promise<void>;
...
interface SetDisplayColorCommand extends BaseDisplayContextCommand {
    type: "setColor";
    colorIndex: number;
    color: DisplayColorRGBOrString$1;
}
...
type DisplayColorRGBOrString$1 = DisplayColorRGB | string;
...
declare class Device {
    ...
    get setDisplayColor(): (colorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean) => Promise<void>;
    ...
    get setDisplayBitmapColor(): (bitmapColorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean) => Promise<void>;
    ...
    get setDisplaySpriteColor(): (spriteColorIndex: number, color: DisplayColorRGBOrString$1, sendImmediately?: boolean) => Promise<void>;
