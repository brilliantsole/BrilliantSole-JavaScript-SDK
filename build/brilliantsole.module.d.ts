...
declare class Device {
    ...
    get drawDisplayPolygon(): (offsetX: number, offsetY: number, radius: number, numberOfSides: number, sendImmediately?: boolean) => Promise<void>;
...
declare function quantizeImage(image: HTMLImageElement, width: number, height: number, numberOfColors: number): Promise<{
    blob: Blob;
    colors: string[];
    colorIndices: number[];
}>;
...
declare function imageToSpriteSheet(image: HTMLImageElement, name: string, width: number, height: number, numberOfColors: number, paletteName: string): Promise<DisplaySpriteSheet>;
