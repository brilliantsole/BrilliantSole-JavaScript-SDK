...
interface FullFileConfiguration extends FileConfiguration {
    checksum: number;
    length: number;
}
...
declare class Device {
    ...
    get sentFileConfigurations(): FullFileConfiguration[];
    get getCurrentSentFileConfiguration(): () => FullFileConfiguration | undefined;
