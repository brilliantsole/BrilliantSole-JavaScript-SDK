...
declare class Device {
    ...
    get drawDisplayWireframe(): (points: Vector2[], edges: DisplayWireframeEdge[], sendImmediately?: boolean) => Promise<void>;
