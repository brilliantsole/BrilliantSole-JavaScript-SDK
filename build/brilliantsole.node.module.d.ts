...
declare class Device {
    ...
    get setDisplayRotationCropTop(): (cropTop: number, sendImmediately: boolean) => void;
    get setDisplayRotationCropRight(): (cropRight: number, sendImmediately: boolean) => void;
    get setDisplayRotationCropBottom(): (cropBottom: number, sendImmediately: boolean) => void;
    get setDisplayRotationCropLeft(): (cropLeft: number, sendImmediately: boolean) => void;
