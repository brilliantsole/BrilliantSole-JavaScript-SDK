...
class DisplayCanvasHelper {
    ...
    drawRoundRect(centerX, centerY, width, height, borderRadius, sendImmediately) {
        _console$6.log({ centerX, centerY, width, height, borderRadius });
