...
(function (global, factory) {
    ...
    class MicrophoneManager {
        ...
        requestRequiredInformation() {
            _console$o.log("requesting required microphone information");
        ...
        async setMicrophoneConfiguration(newMicrophoneConfiguration) {
            _console$o.log({ newMicrophoneConfiguration });
            if (__classPrivateFieldGet(this, _MicrophoneManager_instances, "m", _MicrophoneManager_isMicrophoneConfigurationRedundant).call(this, newMicrophoneConfiguration)) {
                _console$o.log("redundant microphone configuration");
                return;
            }
            ...
            _console$o.log({ setMicrophoneConfigurationData });
        ...
        static AssertValidMicrophoneConfigurationType(microphoneConfigurationType) {
            _console$o.assertEnumWithError(microphoneConfigurationType, MicrophoneConfigurationTypes);
        }
        static AssertValidMicrophoneConfigurationTypeEnum(microphoneConfigurationTypeEnum) {
            _console$o.assertTypeWithError(microphoneConfigurationTypeEnum, "number");
            _console$o.assertWithError(microphoneConfigurationTypeEnum in MicrophoneConfigurationTypes, `invalid microphoneConfigurationTypeEnum ${microphoneConfigurationTypeEnum}`);
        }
        parseMessage(messageType, dataView) {
        ...
        set audioContext(newAudioContext) {
            if (__classPrivateFieldGet(this, _MicrophoneManager_audioContext, "f") == newAudioContext) {
                _console$o.log("redundant audioContext assignment", __classPrivateFieldGet(this, _MicrophoneManager_audioContext, "f"));
                return;
            }
            __classPrivateFieldSet(this, _MicrophoneManager_audioContext, newAudioContext, "f");
            _console$o.log("assigned new audioContext", __classPrivateFieldGet(this, _MicrophoneManager_audioContext, "f"));
        ...
        get gainNode() {
            _console$o.assertWithError(__classPrivateFieldGet(this, _MicrophoneManager_audioContext, "f"), "audioContext assignment required for gainNode");
            if (!__classPrivateFieldGet(this, _MicrophoneManager_gainNode, "f")) {
                _console$o.log("creating gainNode...");
                ...
                _console$o.log("created gainNode", __classPrivateFieldGet(this, _MicrophoneManager_gainNode, "f"));
            }
            return __classPrivateFieldGet(this, _MicrophoneManager_gainNode, "f");
        }
        get mediaStreamDestination() {
            _console$o.assertWithError(__classPrivateFieldGet(this, _MicrophoneManager_audioContext, "f"), "audioContext assignment required for mediaStreamDestination");
            if (!__classPrivateFieldGet(this, _MicrophoneManager_mediaStreamDestination, "f")) {
                _console$o.log("creating mediaStreamDestination...");
                ...
                _console$o.log("created mediaStreamDestination", __classPrivateFieldGet(this, _MicrophoneManager_mediaStreamDestination, "f"));
            }
        ...
        startRecording() {
            if (this.isRecording) {
                _console$o.log("already recording");
                return;
            }
        ...
        stopRecording() {
            if (!this.isRecording) {
                _console$o.log("already not recording");
                return;
            }
            ...
            if (__classPrivateFieldGet(this, _MicrophoneManager_microphoneRecordingData, "f") &&
                ...
                _console$o.log("parsing microphone data...", __classPrivateFieldGet(this, _MicrophoneManager_microphoneRecordingData, "f").length);
    ...
    _a$4 = MicrophoneManager, _MicrophoneManager_microphoneStatus = new WeakMap(), _MicrophoneManager_fadeDuration = new WeakMap(), _MicrophoneManager_playbackTime = new WeakMap(), _MicrophoneManager_microphoneConfiguration = new WeakMap(), _MicrophoneManager_availableMicrophoneConfigurationTypes = new WeakMap(), _MicrophoneManager_audioContext = new WeakMap(), _MicrophoneManager_gainNode = new WeakMap(), _MicrophoneManager_mediaStreamDestination = new WeakMap(), _MicrophoneManager_isRecording = new WeakMap(), _MicrophoneManager_microphoneRecordingData = new WeakMap(), _MicrophoneManager_instances = new WeakSet(), _MicrophoneManager_dispatchEvent_get = function _MicrophoneManager_dispatchEvent_get() {
        ...
        _console$o.assertEnumWithError(newMicrophoneStatus, MicrophoneStatuses);
        if (newMicrophoneStatus == __classPrivateFieldGet(this, _MicrophoneManager_microphoneStatus, "f")) {
            _console$o.log(`redundant microphoneStatus ${newMicrophoneStatus}`);
            return;
        }
        ...
        _console$o.log(`updated microphoneStatus to "${this.microphoneStatus}"`);
    ...
    async function _MicrophoneManager_sendMicrophoneCommand(command, sendImmediately) {
        _console$o.assertEnumWithError(command, MicrophoneCommands);
        _console$o.log(`sending microphone command "${command}"`);
        ...
        _console$o.assertWithError(__classPrivateFieldGet(this, _MicrophoneManager_microphoneStatus, "f") != "idle", `microphone is idle`);
    }, _MicrophoneManager_assertValidBitDepth = function _MicrophoneManager_assertValidBitDepth() {
        _console$o.assertEnumWithError(this.bitDepth, MicrophoneBitDepths);
        ...
        _console$o.log("parsing microphone data", dataView);
        ...
        _console$o.log("samples", samples);
        ...
        while (byteOffset < dataView.byteLength) {
            ...
            _console$o.assertWithError(microphoneConfigurationType, `invalid microphoneConfigurationTypeIndex ${microphoneConfigurationTypeIndex}`);
            ...
            _console$o.log({ microphoneConfigurationType, value });
            parsedMicrophoneConfiguration[microphoneConfigurationType] = value;
        }
        _console$o.log({ parsedMicrophoneConfiguration });
        ...
        _console$o.assertWithError(__classPrivateFieldGet(this, _MicrophoneManager_availableMicrophoneConfigurationTypes, "f"), "must get initial microphoneConfiguration");
        ...
        _console$o.assertWithError(isMicrophoneConfigurationTypeAvailable, `unavailable microphone configuration type "${microphoneConfigurationType}"`);
    ...
    const _console$n = createConsole("SensorDataManager", { log: false });
    const SensorTypes = [
        ...PressureSensorTypes,
        ...MotionSensorTypes,
    ...
    class SensorDataManager {
        ...
        static AssertValidSensorType(sensorType) {
            _console$n.assertEnumWithError(sensorType, SensorTypes);
        }
        static AssertValidSensorTypeEnum(sensorTypeEnum) {
            _console$n.assertTypeWithError(sensorTypeEnum, "number");
            _console$n.assertWithError(sensorTypeEnum in SensorTypes, `invalid sensorTypeEnum ${sensorTypeEnum}`);
        }
        get dispatchEvent() {
            return this.eventDispatcher.dispatchEvent;
        }
        ...
        parseScalars(dataView) {
            for (let byteOffset = 0; byteOffset < dataView.byteLength; byteOffset += 5) {
                ...
                _console$n.log({ sensorType, sensorScalar });
                __classPrivateFieldGet(this, _SensorDataManager_scalars, "f").set(sensorType, sensorScalar);
            }
        }
        parseData(dataView) {
            _console$n.log("sensorData", Array.from(new Uint8Array(dataView.buffer)));
            let byteOffset = 0;
        ...
        parseDataCallback(sensorType, dataView, { timestamp }) {
            ...
            switch (sensorType) {
                ...
                case "microphone":
                    return;
                default:
                    _console$n.error(`uncaught sensorType "${sensorType}"`);
            }
            _console$n.assertWithError(sensorData != null, `no sensorData defined for sensorType "${sensorType}"`);
            _console$n.log({ sensorType, sensorData });
    ...
    const _console$m = createConsole("SensorConfigurationManager", { log: false });
    ...
    class SensorConfigurationManager {
        ...
        async setConfiguration(newSensorConfiguration, clearRest) {
            ...
            _console$m.log({ newSensorConfiguration });
            if (__classPrivateFieldGet(this, _SensorConfigurationManager_instances, "m", _SensorConfigurationManager_isRedundant).call(this, newSensorConfiguration)) {
                _console$m.log("redundant sensor configuration");
                return;
            }
            ...
            _console$m.log({ setSensorConfigurationData });
    ...
    _a$3 = SensorConfigurationManager, _SensorConfigurationManager_availableSensorTypes = new WeakMap(), _SensorConfigurationManager_configuration = new WeakMap(), _SensorConfigurationManager_instances = new WeakSet(), _SensorConfigurationManager_dispatchEvent_get = function _SensorConfigurationManager_dispatchEvent_get() {
        ...
        _console$m.assertWithError(__classPrivateFieldGet(this, _SensorConfigurationManager_availableSensorTypes, "f"), "must get initial sensorConfiguration");
        ...
        _console$m.log(isSensorTypeAvailable, `unavailable sensor type "${sensorType}"`);
        ...
        _console$m.log({ updatedConfiguration: __classPrivateFieldGet(this, _SensorConfigurationManager_configuration, "f") });
        ...
        for (let byteOffset = 0; byteOffset < dataView.byteLength; byteOffset += 3) {
            ...
            _console$m.log({ sensorType, sensorRate });
            if (!sensorType) {
        ...
        _console$m.log({ parsedSensorConfiguration });
        ...
        _console$m.assertTypeWithError(sensorRate, "number");
        _console$m.assertWithError(sensorRate >= 0, `sensorRate must be 0 or greater (got ${sensorRate})`);
        _console$m.assertWithError(sensorRate < MaxSensorRate, `sensorRate must be 0 or greater (got ${sensorRate})`);
        _console$m.assertWithError(sensorRate % SensorRateStep == 0, `sensorRate must be multiple of ${SensorRateStep}`);
    }, _SensorConfigurationManager_assertValidSensorRate = function _SensorConfigurationManager_assertValidSensorRate(sensorRate) {
    ...
    const _console$l = createConsole("TfliteManager", { log: false });
    ...
    class TfliteManager {
        ...
        async setName(newName, sendImmediately) {
            ...
            if (this.name == newName) {
                _console$l.log(`redundant name assignment ${newName}`);
                return;
            }
        ...
        async setTask(newTask, sendImmediately) {
            ...
            if (this.task == newTask) {
                _console$l.log(`redundant task assignment ${newTask}`);
                return;
            }
        ...
        async setSampleRate(newSampleRate, sendImmediately) {
            _console$l.assertTypeWithError(newSampleRate, "number");
            newSampleRate -= newSampleRate % SensorRateStep;
            _console$l.assertWithError(newSampleRate >= SensorRateStep, `sampleRate must be multiple of ${SensorRateStep} greater than 0 (got ${newSampleRate})`);
            if (__classPrivateFieldGet(this, _TfliteManager_sampleRate, "f") == newSampleRate) {
                _console$l.log(`redundant sampleRate assignment ${newSampleRate}`);
                return;
            }
        ...
        static AssertValidSensorType(sensorType) {
            ...
            _console$l.assertWithError(TfliteSensorTypes.includes(tfliteSensorType), `invalid tflite sensorType "${sensorType}"`);
        }
        get sensorTypes() {
        ...
        async setSensorTypes(newSensorTypes, sendImmediately) {
            ...
            const newSensorTypeEnums = newSensorTypes
                ...
                .sort();
            _console$l.log(newSensorTypes, newSensorTypeEnums);
            this.sendMessage([
                {
        ...
        async setCaptureDelay(newCaptureDelay, sendImmediately) {
            _console$l.assertTypeWithError(newCaptureDelay, "number");
            if (__classPrivateFieldGet(this, _TfliteManager_captureDelay, "f") == newCaptureDelay) {
                _console$l.log(`redundant captureDelay assignment ${newCaptureDelay}`);
                return;
            }
        ...
        async setThreshold(newThreshold, sendImmediately) {
            _console$l.assertTypeWithError(newThreshold, "number");
            _console$l.assertWithError(newThreshold >= 0, `threshold must be positive (got ${newThreshold})`);
            if (__classPrivateFieldGet(this, _TfliteManager_threshold, "f") == newThreshold) {
                _console$l.log(`redundant threshold assignment ${newThreshold}`);
                return;
            }
        ...
        async setInferencingEnabled(newInferencingEnabled, sendImmediately = true) {
            _console$l.assertTypeWithError(newInferencingEnabled, "boolean");
            ...
            if (__classPrivateFieldGet(this, _TfliteManager_inferencingEnabled, "f") == newInferencingEnabled) {
                _console$l.log(`redundant inferencingEnabled assignment ${newInferencingEnabled}`);
                return;
            }
        ...
        sendConfiguration(configuration, sendImmediately) {
            if (configuration == __classPrivateFieldGet(this, _TfliteManager_configuration, "f")) {
                _console$l.log("redundant tflite configuration assignment");
                return;
            }
            __classPrivateFieldSet(this, _TfliteManager_configuration, configuration, "f");
            _console$l.log("assigned new tflite configuration", this.configuration);
        ...
        requestRequiredInformation() {
            _console$l.log("requesting required tflite information");
    ...
    _TfliteManager_name = new WeakMap(), _TfliteManager_task = new WeakMap(), _TfliteManager_sampleRate = new WeakMap(), _TfliteManager_sensorTypes = new WeakMap(), _TfliteManager_isReady = new WeakMap(), _TfliteManager_captureDelay = new WeakMap(), _TfliteManager_threshold = new WeakMap(), _TfliteManager_inferencingEnabled = new WeakMap(), _TfliteManager_configuration = new WeakMap(), _TfliteManager_instances = new WeakSet(), _TfliteManager_assertValidTask = function _TfliteManager_assertValidTask(task) {
        _console$l.assertEnumWithError(task, TfliteTasks);
    }, _TfliteManager_assertValidTaskEnum = function _TfliteManager_assertValidTaskEnum(taskEnum) {
        _console$l.assertWithError(taskEnum in TfliteTasks, `invalid taskEnum ${taskEnum}`);
        ...
        _console$l.log("parseName", dataView);
        ...
        _console$l.log("parseTask", dataView);
        ...
        _console$l.log("parseSampleRate", dataView);
        ...
        _console$l.log("parseSensorTypes", dataView);
        const sensorTypes = [];
        for (let index = 0; index < dataView.byteLength; index++) {
            ...
            if (sensorType) {
                if (TfliteSensorTypes.includes(sensorType)) {
                    ...
                    _console$l.error(`invalid tfliteSensorType ${sensorType}`);
                }
            }
            else {
                _console$l.error(`invalid sensorTypeEnum ${sensorTypeEnum}`);
            }
        }
        ...
        _console$l.log("parseIsReady", dataView);
        ...
        _console$l.assertWithError(this.isReady, `tflite is not ready`);
    }, _TfliteManager_parseCaptureDelay = function _TfliteManager_parseCaptureDelay(dataView) {
        _console$l.log("parseCaptureDelay", dataView);
        ...
        _console$l.log("parseThreshold", dataView);
        ...
        _console$l.log("parseInferencingEnabled", dataView);
        ...
        _console$l.log({ inferencingEnabled });
        ...
        _console$l.log("parseInference", dataView);
        const timestamp = parseTimestamp(dataView, 0);
        _console$l.log({ timestamp });
        const values = [];
        ...
        if (this.task == "classification") {
            ...
            _console$l.log({ maxIndex, maxValue });
    ...
    const _console$k = createConsole("DeviceInformationManager", { log: false });
        ...
        parseMessage(messageType, dataView) {
            ...
            switch (messageType) {
                case "manufacturerName":
                    ...
                    _console$k.log({ manufacturerName });
                ...
                case "softwareRevision":
                    ...
                    _console$k.log({ softwareRevision });
                ...
                case "hardwareRevision":
                    ...
                    _console$k.log({ hardwareRevision });
                ...
                case "firmwareRevision":
                    ...
                    _console$k.log({ firmwareRevision });
    ...
    _DeviceInformationManager_information = new WeakMap(), _DeviceInformationManager_instances = new WeakSet(), _DeviceInformationManager_dispatchEvent_get = function _DeviceInformationManager_dispatchEvent_get() {
        ...
        _console$k.log({ partialDeviceInformation });
        ...
        _console$k.log({ deviceInformation: __classPrivateFieldGet(this, _DeviceInformationManager_information, "f") });
        if (__classPrivateFieldGet(this, _DeviceInformationManager_instances, "a", _DeviceInformationManager_isComplete_get)) {
            _console$k.log("completed deviceInformation");
    ...
    class InformationManager {
        ...
        async getBatteryCurrent() {
            _console$j.log("getting battery current...");
        ...
        updateName(updatedName) {
            _console$j.assertTypeWithError(updatedName, "string");
            __classPrivateFieldSet(this, _InformationManager_name, updatedName, "f");
            _console$j.log({ updatedName: __classPrivateFieldGet(this, _InformationManager_name, "f") });
        ...
        async setName(newName) {
            ...
            _console$j.assertRangeWithError("newName", newName.length, MinNameLength, MaxNameLength);
            const setNameData = textEncoder.encode(newName);
            _console$j.log({ setNameData });
        ...
        updateType(updatedType) {
            ...
            if (updatedType == this.type) {
                _console$j.log("redundant type assignment");
                return;
            }
            __classPrivateFieldSet(this, _InformationManager_type, updatedType, "f");
            _console$j.log({ updatedType: __classPrivateFieldGet(this, _InformationManager_type, "f") });
    ...
    _InformationManager_isCharging = new WeakMap(), _InformationManager_batteryCurrent = new WeakMap(), _InformationManager_id = new WeakMap(), _InformationManager_name = new WeakMap(), _InformationManager_type = new WeakMap(), _InformationManager_mtu = new WeakMap(), _InformationManager_isCurrentTimeSet = new WeakMap(), _InformationManager_instances = new WeakSet(), _InformationManager_dispatchEvent_get = function _InformationManager_dispatchEvent_get() {
        ...
        _console$j.assertTypeWithError(updatedIsCharging, "boolean");
        __classPrivateFieldSet(this, _InformationManager_isCharging, updatedIsCharging, "f");
        _console$j.log({ isCharging: __classPrivateFieldGet(this, _InformationManager_isCharging, "f") });
        ...
        _console$j.assertTypeWithError(updatedBatteryCurrent, "number");
        __classPrivateFieldSet(this, _InformationManager_batteryCurrent, updatedBatteryCurrent, "f");
        _console$j.log({ batteryCurrent: __classPrivateFieldGet(this, _InformationManager_batteryCurrent, "f") });
        ...
        _console$j.assertTypeWithError(updatedId, "string");
        __classPrivateFieldSet(this, _InformationManager_id, updatedId, "f");
        _console$j.log({ id: __classPrivateFieldGet(this, _InformationManager_id, "f") });
        ...
        _console$j.assertEnumWithError(type, DeviceTypes);
        ...
        _console$j.assertTypeWithError(newMtu, "number");
        if (__classPrivateFieldGet(this, _InformationManager_mtu, "f") == newMtu) {
            _console$j.log("redundant mtu assignment", newMtu);
            return;
        }
        ...
        _console$j.log("setting current time...");
    ...
    const _console$i = createConsole("VibrationManager", { log: false });
    ...
    class VibrationManager {
        ...
        async triggerVibration(vibrationConfigurations, sendImmediately = true) {
            ...
            vibrationConfigurations.forEach((vibrationConfiguration) => {
                ...
                _console$i.log({ type, arrayBuffer });
    ...
    _VibrationManager_vibrationLocations = new WeakMap(), _VibrationManager_instances = new WeakSet(), _VibrationManager_dispatchEvent_get = function _VibrationManager_dispatchEvent_get() {
        ...
        _console$i.assertTypeWithError(location, "string");
        _console$i.assertWithError(VibrationLocations.includes(location), `invalid location "${location}"`);
        ...
        _console$i.log({ locationsBitmask });
        _console$i.assertWithError(locationsBitmask > 0, `locationsBitmask must not be zero`);
        return locationsBitmask;
    }, _VibrationManager_assertNonEmptyArray = function _VibrationManager_assertNonEmptyArray(array) {
        _console$i.assertWithError(Array.isArray(array), "passed non-array");
        _console$i.assertWithError(array.length > 0, "passed empty array");
    }, _VibrationManager_verifyWaveformEffect = function _VibrationManager_verifyWaveformEffect(waveformEffect) {
        _console$i.assertWithError(VibrationWaveformEffects.includes(waveformEffect), `invalid waveformEffect "${waveformEffect}"`);
        ...
        if (waveformEffectSegment.effect != undefined) {
            ...
            _console$i.assertWithError(delay >= 0, `delay must be 0ms or greater (got ${delay})`);
            _console$i.assertWithError(delay <= MaxVibrationWaveformEffectSegmentDelay, `delay must be ${MaxVibrationWaveformEffectSegmentDelay}ms or less (got ${delay})`);
        }
        else {
        ...
        _console$i.assertTypeWithError(waveformEffectSegmentLoopCount, "number");
        _console$i.assertWithError(waveformEffectSegmentLoopCount >= 0, `waveformEffectSegmentLoopCount must be 0 or greater (got ${waveformEffectSegmentLoopCount})`);
        _console$i.assertWithError(waveformEffectSegmentLoopCount <=
        ...
        _console$i.assertWithError(waveformEffectSegments.length <=
        ...
        _console$i.assertTypeWithError(waveformEffectSequenceLoopCount, "number");
        _console$i.assertWithError(waveformEffectSequenceLoopCount >= 0, `waveformEffectSequenceLoopCount must be 0 or greater (got ${waveformEffectSequenceLoopCount})`);
        _console$i.assertWithError(waveformEffectSequenceLoopCount <=
        ...
        _console$i.assertTypeWithError(waveformSegment.amplitude, "number");
        _console$i.assertWithError(waveformSegment.amplitude >= 0, `amplitude must be 0 or greater (got ${waveformSegment.amplitude})`);
        _console$i.assertWithError(waveformSegment.amplitude <= 1, `amplitude must be 1 or less (got ${waveformSegment.amplitude})`);
        _console$i.assertTypeWithError(waveformSegment.duration, "number");
        _console$i.assertWithError(waveformSegment.duration > 0, `duration must be greater than 0ms (got ${waveformSegment.duration}ms)`);
        _console$i.assertWithError(waveformSegment.duration <= MaxVibrationWaveformSegmentDuration, `duration must be ${MaxVibrationWaveformSegmentDuration}ms or less (got ${waveformSegment.duration}ms)`);
        ...
        _console$i.assertWithError(waveformSegments.length <= MaxNumberOfVibrationWaveformSegments, `must have ${MaxNumberOfVibrationWaveformSegments} waveformSegments or fewer (got ${waveformSegments.length})`);
        ...
        _console$i.log({ dataArray, dataView });
        ...
        _console$i.assertTypeWithError(vibrationType, "string");
        _console$i.assertWithError(VibrationTypes.includes(vibrationType), `invalid vibrationType "${vibrationType}"`);
    }, _VibrationManager_createData = function _VibrationManager_createData(locations, vibrationType, dataView) {
        _console$i.assertWithError(dataView?.byteLength > 0, "no data received");
        ...
        _console$i.log({ locationsBitmask, vibrationTypeIndex, dataView });
        ...
        _console$i.log("vibrationLocations", vibrationLocations);
    ...
    const _console$h = createConsole("WifiManager", { log: false });
    ...
    class WifiManager {
        ...
        requestRequiredInformation() {
            _console$h.log("requesting required wifi information");
        ...
        async setWifiSSID(newWifiSSID) {
            ...
            if (__classPrivateFieldGet(this, _WifiManager_wifiConnectionEnabled, "f")) {
                _console$h.error("cannot change ssid while wifi connection is enabled");
                return;
            }
            _console$h.assertTypeWithError(newWifiSSID, "string");
            _console$h.assertRangeWithError("wifiSSID", newWifiSSID.length, MinWifiSSIDLength, MaxWifiSSIDLength);
            const setWifiSSIDData = textEncoder.encode(newWifiSSID);
            _console$h.log({ setWifiSSIDData });
        ...
        async setWifiPassword(newWifiPassword) {
            __classPrivateFieldGet(this, _WifiManager_instances, "m", _WifiManager_assertWifiIsAvailable).call(this);
            if (__classPrivateFieldGet(this, _WifiManager_wifiConnectionEnabled, "f")) {
                _console$h.error("cannot change password while wifi connection is enabled");
                return;
            }
            _console$h.assertTypeWithError(newWifiPassword, "string");
            if (newWifiPassword.length > 0) {
                _console$h.assertRangeWithError("wifiPassword", newWifiPassword.length, MinWifiPasswordLength, MaxWifiPasswordLength);
            }
            const setWifiPasswordData = textEncoder.encode(newWifiPassword);
            _console$h.log({ setWifiPasswordData });
        ...
        async setWifiConnectionEnabled(newWifiConnectionEnabled, sendImmediately = true) {
            __classPrivateFieldGet(this, _WifiManager_instances, "m", _WifiManager_assertWifiIsAvailable).call(this);
            _console$h.assertTypeWithError(newWifiConnectionEnabled, "boolean");
            if (__classPrivateFieldGet(this, _WifiManager_wifiConnectionEnabled, "f") == newWifiConnectionEnabled) {
                _console$h.log(`redundant wifiConnectionEnabled assignment ${newWifiConnectionEnabled}`);
                return;
            }
        ...
        parseMessage(messageType, dataView) {
            ...
            switch (messageType) {
                case "isWifiAvailable":
                    ...
                    _console$h.log({ isWifiAvailable });
                ...
                case "setWifiConnectionEnabled":
                    ...
                    _console$h.log({ enableWifiConnection });
                ...
                case "isWifiConnected":
                    ...
                    _console$h.log({ isWifiConnected });
    ...
    _WifiManager_isWifiAvailable = new WeakMap(), _WifiManager_wifiSSID = new WeakMap(), _WifiManager_wifiPassword = new WeakMap(), _WifiManager_wifiConnectionEnabled = new WeakMap(), _WifiManager_isWifiConnected = new WeakMap(), _WifiManager_ipAddress = new WeakMap(), _WifiManager_isWifiSecure = new WeakMap(), _WifiManager_instances = new WeakSet(), _WifiManager_dispatchEvent_get = function _WifiManager_dispatchEvent_get() {
        ...
        _console$h.assertTypeWithError(updatedIsWifiAvailable, "boolean");
        __classPrivateFieldSet(this, _WifiManager_isWifiAvailable, updatedIsWifiAvailable, "f");
        _console$h.log({ isWifiAvailable: __classPrivateFieldGet(this, _WifiManager_isWifiAvailable, "f") });
        ...
        _console$h.assertWithError(__classPrivateFieldGet(this, _WifiManager_isWifiAvailable, "f"), "wifi is not available");
    }, _WifiManager_updateWifiSSID = function _WifiManager_updateWifiSSID(updatedWifiSSID) {
        _console$h.assertTypeWithError(updatedWifiSSID, "string");
        __classPrivateFieldSet(this, _WifiManager_wifiSSID, updatedWifiSSID, "f");
        _console$h.log({ wifiSSID: __classPrivateFieldGet(this, _WifiManager_wifiSSID, "f") });
        ...
        _console$h.assertTypeWithError(updatedWifiPassword, "string");
        __classPrivateFieldSet(this, _WifiManager_wifiPassword, updatedWifiPassword, "f");
        _console$h.log({ wifiPassword: __classPrivateFieldGet(this, _WifiManager_wifiPassword, "f") });
        ...
        _console$h.log({ wifiConnectionEnabled });
        ...
        _console$h.assertTypeWithError(updatedIsWifiConnected, "boolean");
        __classPrivateFieldSet(this, _WifiManager_isWifiConnected, updatedIsWifiConnected, "f");
        _console$h.log({ isWifiConnected: __classPrivateFieldGet(this, _WifiManager_isWifiConnected, "f") });
        ...
        _console$h.log({ ipAddress: __classPrivateFieldGet(this, _WifiManager_ipAddress, "f") });
        ...
        _console$h.assertTypeWithError(updatedIsWifiSecure, "boolean");
        __classPrivateFieldSet(this, _WifiManager_isWifiSecure, updatedIsWifiSecure, "f");
        _console$h.log({ isWifiSecure: __classPrivateFieldGet(this, _WifiManager_isWifiSecure, "f") });
    ...
    const _console$g = createConsole("ColorUtils", { log: true });
    function hexToRGB(hex) {
        ...
        _console$g.assertWithError(hex.length == 6, `hex length must be 6 (got ${hex.length})`);
    ...
    const _console$f = createConsole("DisplayManager", { log: true });
    ...
    class DisplayManager {
        ...
        requestRequiredInformation() {
            _console$f.log("requesting required display information");
        ...
        setColor(colorIndex, color, sendImmediately) {
            ...
            _console$f.log(`setting color #${colorIndex}`, color);
        ...
        fillRect(x, y, width, height, sendImmediately) {
            ...
            dataView.setUint16(4, _width, true);
            dataView.setUint16(6, _height, true);
            _console$f.log("fillRectData", dataView);
    ...
    _DisplayManager_isDisplayAvailable = new WeakMap(), _DisplayManager_displayStatus = new WeakMap(), _DisplayManager_displayInformation = new WeakMap(), _DisplayManager_displayBrightness = new WeakMap(), _DisplayManager_displayContextCommandBuffers = new WeakMap(), _DisplayManager_mtu = new WeakMap(), _DisplayManager_instances = new WeakSet(), _DisplayManager_dispatchEvent_get = function _DisplayManager_dispatchEvent_get() {
        ...
        _console$f.assertWithError(__classPrivateFieldGet(this, _DisplayManager_isDisplayAvailable, "f"), "display is not available");
        ...
        _console$f.log({ isDisplayAvailable: __classPrivateFieldGet(this, _DisplayManager_isDisplayAvailable, "f") });
        ...
        _console$f.assertEnumWithError(newDisplayStatus, DisplayStatuses);
        if (newDisplayStatus == __classPrivateFieldGet(this, _DisplayManager_displayStatus, "f")) {
            _console$f.log(`redundant displayStatus ${newDisplayStatus}`);
            return;
        }
        ...
        _console$f.log(`updated displayStatus to "${this.displayStatus}"`);
    ...
    async function _DisplayManager_sendDisplayCommand(command, sendImmediately) {
        _console$f.assertEnumWithError(command, DisplayCommands);
        _console$f.log(`sending display command "${command}"`);
        ...
        _console$f.assertWithError(__classPrivateFieldGet(this, _DisplayManager_displayStatus, "f") == "awake", `display is not awake - currently ${__classPrivateFieldGet(this, _DisplayManager_displayStatus, "f")}`);
    }, _DisplayManager_assertIsNotAwake = function _DisplayManager_assertIsNotAwake() {
        _console$f.assertWithError(__classPrivateFieldGet(this, _DisplayManager_displayStatus, "f") != "awake", `display is awake`);
        ...
        while (byteOffset < dataView.byteLength) {
            ...
            _console$f.assertWithError(displayInformationType, `invalid displayInformationTypeIndex ${displayInformationType}`);
            _console$f.log({ displayInformationType });
                ...
                case "type":
                    {
                        ...
                        let rawValue = dataView.getUint8(byteOffset++);
                        const value = values[rawValue];
                        _console$f.assertEnumWithError(value, values);
                        parsedDisplayInformation[displayInformationType] = value;
                    }
                    break;
            }
        }
        _console$f.log({ parsedDisplayInformation });
        const missingDisplayInformationType = DisplayInformationTypes.find((type) => !(type in parsedDisplayInformation));
        _console$f.assertWithError(!missingDisplayInformationType, `missingDisplayInformationType ${missingDisplayInformationType}`);
        ...
        _console$f.log({ displayBrightness: __classPrivateFieldGet(this, _DisplayManager_displayBrightness, "f") });
        ...
        _console$f.assertEnumWithError(displayBrightness, DisplayBrightnesses);
        ...
        _console$f.assertEnumWithError(displayContextCommand, DisplayContextCommands);
        ...
        if (newLength > this.mtu - 6) {
            _console$f.log("displayContextCommandBuffers too full - sending now");
        ...
        _console$f.log(`sending displayContextCommands`);
        ...
        _console$f.assertRangeWithError("colorIndex", colorIndex, 0, this.numberOfColors);
        ...
        _console$f.log("clampBox", { x, y, width, height });
    ...
    const _console$e = createConsole("BaseConnectionManager", { log: false });
    ...
    class BaseConnectionManager {
        ...
        set status(newConnectionStatus) {
            _console$e.assertEnumWithError(newConnectionStatus, ConnectionStatuses);
            if (__classPrivateFieldGet(this, _BaseConnectionManager_status, "f") == newConnectionStatus) {
                _console$e.log(`tried to assign same connection status "${newConnectionStatus}"`);
                return;
            }
            _console$e.log(`new connection status "${newConnectionStatus}"`);
        ...
        assertIsNotConnected() {
            _console$e.assertWithError(!this.isConnected, "device is already connected");
        }
        assertIsConnected() {
            _console$e.assertWithError(this.isConnected, "device is not connected");
        }
        ...
        async reconnect() {
            this.assertIsNotConnected();
            __classPrivateFieldGet(this, _BaseConnectionManager_instances, "m", _BaseConnectionManager_assertIsNotConnecting).call(this);
            _console$e.assertWithError(this.canReconnect, "unable to reconnect");
            this.status = "connecting";
        ...
        async disconnect() {
            ...
            _console$e.log("disconnecting from device...");
        }
        async sendSmpMessage(data) {
            this.assertIsConnectedAndNotDisconnecting();
            _console$e.log("sending smp message", data);
        }
        async sendTxMessages(messages, sendImmediately = true) {
            ...
            if (messages) {
                ...
                _console$e.log(`appended ${messages.length} messages`);
            }
            if (!sendImmediately) {
                _console$e.log("not sending immediately - waiting until later");
                return;
            }
            if (__classPrivateFieldGet(this, _BaseConnectionManager_isSendingMessages, "f")) {
                _console$e.log("already sending messages - waiting until later");
                return;
            }
            if (__classPrivateFieldGet(this, _BaseConnectionManager_pendingMessages, "f").length == 0) {
                _console$e.log("no pendingMessages");
                return;
            }
            __classPrivateFieldSet(this, _BaseConnectionManager_isSendingMessages, true, "f");
            _console$e.log("sendTxMessages", __classPrivateFieldGet(this, _BaseConnectionManager_pendingMessages, "f").slice());
            ...
            if (this.mtu) {
                while (arrayBuffers.length > 0) {
                    if (arrayBuffers.every((arrayBuffer) => arrayBuffer.byteLength > this.mtu - 3)) {
                        _console$e.log("every arrayBuffer is too big to send");
                        break;
                    }
                    _console$e.log("remaining arrayBuffers.length", arrayBuffers.length);
                    let arrayBufferByteLength = 0;
                    let arrayBufferCount = 0;
                    arrayBuffers.some((arrayBuffer) => {
                        if (arrayBufferByteLength + arrayBuffer.byteLength > this.mtu - 3) {
                            _console$e.log(`stopping appending arrayBuffers ( length ${arrayBuffer.byteLength} too much)`);
                            return true;
                        }
                        _console$e.log(`allowing arrayBuffer with length ${arrayBuffer.byteLength}`);
                        arrayBufferCount++;
                        arrayBufferByteLength += arrayBuffer.byteLength;
                    });
                    const arrayBuffersToSend = arrayBuffers.splice(0, arrayBufferCount);
                    _console$e.log({ arrayBufferCount, arrayBuffersToSend });
                    const arrayBuffer = concatenateArrayBuffers(...arrayBuffersToSend);
                    _console$e.log("sending arrayBuffer (partitioned)", arrayBuffer);
                    await this.sendTxData(arrayBuffer);
                }
            }
            else {
                const arrayBuffer = concatenateArrayBuffers(...arrayBuffers);
                _console$e.log("sending arrayBuffer (all)", arrayBuffer);
                await this.sendTxData(arrayBuffer);
            }
        ...
        async sendTxData(data) {
            _console$e.log("sendTxData", data);
        }
    ...
    _a$2 = BaseConnectionManager, _BaseConnectionManager_status = new WeakMap(), _BaseConnectionManager_pendingMessages = new WeakMap(), _BaseConnectionManager_isSendingMessages = new WeakMap(), _BaseConnectionManager_timer = new WeakMap(), _BaseConnectionManager_instances = new WeakSet(), _BaseConnectionManager_AssertValidTxRxMessageType = function _BaseConnectionManager_AssertValidTxRxMessageType(messageType) {
        _console$e.assertEnumWithError(messageType, TxRxMessageTypes);
        ...
        _console$e.assertWithError(this.status != "connecting", "device is already connecting");
    }, _BaseConnectionManager_assertIsNotDisconnecting = function _BaseConnectionManager_assertIsNotDisconnecting() {
        _console$e.assertWithError(this.status != "disconnecting", "device is already disconnecting");
        ...
        if (!this.isConnected) {
            _console$e.log("timer detected disconnection");
    ...
    const _console$d = createConsole("EventUtils", { log: false });
    function addEventListeners(target, boundEventListeners) {
        ...
        _console$d.assertWithError(addEventListener, "no add listener function found for target");
    ...
    function removeEventListeners(target, boundEventListeners) {
        ...
        _console$d.assertWithError(removeEventListener, "no remove listener function found for target");
    ...
    function generateBluetoothUUID(value) {
        _console$c.assertTypeWithError(value, "string");
        _console$c.assertWithError(value.length == 4, "value must be 4 characters long");
    ...
    const _console$b = createConsole("BluetoothConnectionManager", { log: false });
    class BluetoothConnectionManager extends BaseConnectionManager {
        ...
        async writeCharacteristic(characteristicName, data) {
            _console$b.log("writeCharacteristic", ...arguments);
        }
        async sendSmpMessage(data) {
    ...
    const _console$a = createConsole("WebBluetoothConnectionManager", { log: false });
    var bluetooth;
    class WebBluetoothConnectionManager extends BluetoothConnectionManager {
        ...
        set device(newDevice) {
            if (__classPrivateFieldGet(this, _WebBluetoothConnectionManager_device, "f") == newDevice) {
                _console$a.log("tried to assign the same BluetoothDevice");
                return;
            }
        ...
        async connect() {
            ...
            try {
                ...
                _console$a.log("got BluetoothDevice");
                this.device = device;
                _console$a.log("connecting to device...");
                const server = await this.server.connect();
                _console$a.log(`connected to device? ${server.connected}`);
        ...
        async writeCharacteristic(characteristicName, data) {
            ...
            _console$a.assertWithError(characteristic, `${characteristicName} characteristic not found`);
            _console$a.log("writing characteristic", characteristic, data);
            ...
            if (characteristicProperties.writeWithoutResponse) {
                _console$a.log("writing without response");
                await characteristic.writeValueWithoutResponse(data);
            }
            else {
                _console$a.log("writing with response");
                await characteristic.writeValueWithResponse(data);
            }
            _console$a.log("wrote characteristic");
            if (characteristicProperties.read && !characteristicProperties.notify) {
                _console$a.log("reading value after write...");
        ...
        async reconnect() {
            ...
            if (this.isConnected) {
                _console$a.log("successfully reconnected!");
                await __classPrivateFieldGet(this, _WebBluetoothConnectionManager_instances, "m", _WebBluetoothConnectionManager_getServicesAndCharacteristics).call(this);
                this.status = "connected";
            }
            else {
                _console$a.log("unable to reconnect");
                this.status = "notConnected";
            }
        }
        remove() {
    ...
    _WebBluetoothConnectionManager_boundBluetoothCharacteristicEventListeners = new WeakMap(), _WebBluetoothConnectionManager_boundBluetoothDeviceEventListeners = new WeakMap(), _WebBluetoothConnectionManager_device = new WeakMap(), _WebBluetoothConnectionManager_services = new WeakMap(), _WebBluetoothConnectionManager_characteristics = new WeakMap(), _WebBluetoothConnectionManager_instances = new WeakSet(), _WebBluetoothConnectionManager_getServicesAndCharacteristics = async function _WebBluetoothConnectionManager_getServicesAndCharacteristics() {
        __classPrivateFieldGet(this, _WebBluetoothConnectionManager_instances, "m", _WebBluetoothConnectionManager_removeEventListeners).call(this);
        _console$a.log("getting services...");
        const services = await this.server.getPrimaryServices();
        _console$a.log("got services", services.length);
        _console$a.log("getting characteristics...");
        for (const serviceIndex in services) {
            const service = services[serviceIndex];
            _console$a.log({ service });
            const serviceName = getServiceNameFromUUID(service.uuid);
            _console$a.assertWithError(serviceName, `no name found for service uuid "${service.uuid}"`);
            _console$a.log(`got "${serviceName}" service`);
            service.name = serviceName;
            __classPrivateFieldGet(this, _WebBluetoothConnectionManager_services, "f").set(serviceName, service);
            _console$a.log(`getting characteristics for "${serviceName}" service`);
            const characteristics = await service.getCharacteristics();
            _console$a.log(`got characteristics for "${serviceName}" service`);
            for (const characteristicIndex in characteristics) {
                const characteristic = characteristics[characteristicIndex];
                _console$a.log({ characteristic });
                const characteristicName = getCharacteristicNameFromUUID(characteristic.uuid);
                _console$a.assertWithError(Boolean(characteristicName), `no name found for characteristic uuid "${characteristic.uuid}" in "${serviceName}" service`);
                _console$a.log(`got "${characteristicName}" characteristic in "${serviceName}" service`);
                ...
                if (characteristicProperties.notify) {
                    _console$a.log(`starting notifications for "${characteristicName}" characteristic`);
                    await characteristic.startNotifications();
                }
                if (characteristicProperties.read) {
                    _console$a.log(`reading "${characteristicName}" characteristic...`);
                    await characteristic.readValue();
                    if (isInBluefy || isInWebBLE) {
                        __classPrivateFieldGet(this, _WebBluetoothConnectionManager_instances, "m", _WebBluetoothConnectionManager_onCharacteristicValueChanged).call(this, characteristic);
                    }
        ...
        const promises = Array.from(__classPrivateFieldGet(this, _WebBluetoothConnectionManager_characteristics, "f").keys()).map((characteristicName) => {
            ...
            const characteristicProperties = characteristic.properties ||
                getCharacteristicProperties(characteristicName);
            if (characteristicProperties.notify) {
                _console$a.log(`stopping notifications for "${characteristicName}" characteristic`);
        ...
        _console$a.log("oncharacteristicvaluechanged");
        ...
        _console$a.log("onCharacteristicValue");
        ...
        _console$a.log(`oncharacteristicvaluechanged for "${characteristicName}" characteristic`);
        const dataView = characteristic.value;
        _console$a.assertWithError(dataView, `no data found for "${characteristicName}" characteristic`);
        _console$a.log(`data for "${characteristicName}" characteristic`, Array.from(new Uint8Array(dataView.buffer)));
        try {
        ...
        _console$a.log("gattserverdisconnected");
        this.status = "notConnected";
    };
    ...
    const _console$9 = createConsole("mcumgr", {
      log: false
    });
    const constants = {
      MGMT_OP_READ: 0,
    ...
    class MCUManager {
      ...
      _notification(buffer) {
        _console$9.log("mcumgr - message received");
      ...
      _processMessage(message) {
        ...
        _console$9.log("mcumgr - Process Message - Group: " + group + ", Id: " + id + ", Off: " + data.off);
        ...
        if (op === constants.MGMT_OP_READ_RSP && group === constants.MGMT_GROUP_ID_FS && id === constants.FS_MGMT_ID_FILE) {
          ...
          _console$9.log("downloaded " + this._downloadFileOffset + " bytes of " + this._downloadFileLength);
      ...
      async _uploadNext() {
        ...
        _console$9.log("mcumgr - _uploadNext: Message Length: " + packet.length);
      ...
      async cmdUpload(image) {
        ...
        if (this._uploadIsInProgress) {
          _console$9.error("Upload is already in progress.");
          return;
        }
      ...
      async _uploadFileNext() {
        _console$9.log("uploadFileNext - offset: " + this._uploadFileOffset + ", length: " + this._uploadFile.byteLength);
      ...
      async cmdDownloadFile(filename, destFilename) {
        if (this._downloadIsInProgress) {
          _console$9.error("Download is already in progress.");
          return;
        }
      ...
      async _downloadFileNext() {
        ...
        _console$9.log("mcumgr - _downloadNext: Message Length: " + packet.length);
    ...
    const _console$8 = createConsole("FirmwareManager", { log: false });
    ...
    class FirmwareManager {
        ...
        async uploadFirmware(file) {
            _console$8.log("uploadFirmware", file);
        ...
        async getImages() {
            ...
            _console$8.log("getting firmware image state...");
        ...
        async confirmImage(imageIndex = 0) {
            ...
            if (__classPrivateFieldGet(this, _FirmwareManager_images, "f")[imageIndex].confirmed === true) {
                _console$8.log(`image ${imageIndex} is already confirmed`);
                return;
            }
            const promise = this.waitForEvent("smp");
            _console$8.log("confirming image...");
        ...
        async echo(string) {
            _console$8.assertTypeWithError(string, "string");
            const promise = this.waitForEvent("smp");
            _console$8.log("sending echo...");
    ...
    _FirmwareManager_status = new WeakMap(), _FirmwareManager_images = new WeakMap(), _FirmwareManager_mtu = new WeakMap(), _FirmwareManager_mcuManager = new WeakMap(), _FirmwareManager_instances = new WeakSet(), _FirmwareManager_dispatchEvent_get = function _FirmwareManager_dispatchEvent_get() {
        ...
        _console$8.assertEnumWithError(newStatus, FirmwareStatuses);
        if (__classPrivateFieldGet(this, _FirmwareManager_status, "f") == newStatus) {
            _console$8.log(`redundant firmwareStatus assignment "${newStatus}"`);
            return;
        }
        __classPrivateFieldSet(this, _FirmwareManager_status, newStatus, "f");
        _console$8.log({ firmwareStatus: __classPrivateFieldGet(this, _FirmwareManager_status, "f") });
        ...
        _console$8.assertWithError(__classPrivateFieldGet(this, _FirmwareManager_images, "f"), "didn't get imageState");
    }, _FirmwareManager_assertValidImageIndex = function _FirmwareManager_assertValidImageIndex(imageIndex) {
        _console$8.assertTypeWithError(imageIndex, "number");
        _console$8.assertWithError(imageIndex == 0 || imageIndex == 1, "imageIndex must be 0 or 1");
        ...
        _console$8.log("onMcuImageUploadProgress", ...arguments);
        ...
        _console$8.log("onMcuImageUploadFinished", ...arguments);
        await this.getImages();
        ...
        if (images) {
            ...
            _console$8.log("images", __classPrivateFieldGet(this, _FirmwareManager_images, "f"));
        }
        else {
            _console$8.log("no images found");
            return;
        }
        let newStatus = "idle";
        if (__classPrivateFieldGet(this, _FirmwareManager_images, "f").length == 2) {
            if (!__classPrivateFieldGet(this, _FirmwareManager_images, "f")[1].bootable) {
                _console$8.warn('Slot 1 has a invalid image. Click "Erase Image" to erase it or upload a different image');
            }
            else if (!__classPrivateFieldGet(this, _FirmwareManager_images, "f")[0].confirmed) {
                _console$8.log('Slot 0 has a valid image. Click "Confirm Image" to confirm it or wait and the device will swap images back.');
                newStatus = "testing";
            }
            else {
                if (__classPrivateFieldGet(this, _FirmwareManager_images, "f")[1].pending) {
                    _console$8.log("reset to upload to the new firmware image");
                    newStatus = "pending";
                }
                else {
                    _console$8.log("Slot 1 has a valid image. run testImage() to test it or upload a different image.");
                    newStatus = "uploaded";
                }
            }
        }
        if (__classPrivateFieldGet(this, _FirmwareManager_images, "f").length == 1) {
            ...
            _console$8.log("Select a firmware upload image to upload to slot 1.");
        }
    ...
    const _console$7 = createConsole("DeviceManager", { log: false });
    ...
    class DeviceManager {
        ...
        _CheckDeviceAvailability(device) {
            if (!device.isConnected &&
                !device.isAvailable &&
                __classPrivateFieldGet(this, _DeviceManager_AvailableDevices, "f").includes(device)) {
                _console$7.log("removing device from availableDevices...");
    ...
    _DeviceManager_boundDeviceEventListeners = new WeakMap(), _DeviceManager_ConnectedDevices = new WeakMap(), _DeviceManager_UseLocalStorage = new WeakMap(), _DeviceManager_DefaultLocalStorageConfiguration = new WeakMap(), _DeviceManager_LocalStorageConfiguration = new WeakMap(), _DeviceManager_LocalStorageKey = new WeakMap(), _DeviceManager_AvailableDevices = new WeakMap(), _DeviceManager_EventDispatcher = new WeakMap(), _DeviceManager_instances = new WeakSet(), _DeviceManager_onDeviceType = function _DeviceManager_onDeviceType(event) {
        ...
        if (device.connectionType != "webBluetooth") {
            _console$7.log("localStorage is only for webBluetooth devices");
            return;
        }
        __classPrivateFieldGet(this, _DeviceManager_instances, "m", _DeviceManager_AssertLocalStorage).call(this);
    ...
    const _console$6 = createConsole("ServerUtils", { log: false });
    ...
    function createMessage(enumeration, ...messages) {
        _console$6.log("createMessage", ...messages);
        const messageBuffers = messages.map((message) => {
            ...
            _console$6.assertEnumWithError(message.type, enumeration);
        ...
        _console$6.log("messageBuffers", ...messageBuffers);
        return concatenateArrayBuffers(...messageBuffers);
    }
    function createServerMessage(...messages) {
        _console$6.log("createServerMessage", ...messages);
    ...
    const _console$5 = createConsole("WebSocketUtils", { log: false });
    ...
    function createWebSocketMessage$1(...messages) {
        _console$5.log("createWebSocketMessage", ...messages);
    ...
    const _console$4 = createConsole("WebSocketConnectionManager", { log: false });
    ...
    function createWebSocketMessage(...messages) {
        _console$4.log("createWebSocketMessage", ...messages);
    ...
    class WebSocketConnectionManager extends BaseConnectionManager {
        ...
        set webSocket(newWebSocket) {
            if (__classPrivateFieldGet(this, _WebSocketConnectionManager_webSocket, "f") == newWebSocket) {
                _console$4.log("redundant webSocket assignment");
                return;
            }
            _console$4.log("assigning webSocket", newWebSocket);
            ...
            _console$4.log("assigned webSocket");
        }
        get ipAddress() {
        ...
        set ipAddress(newIpAddress) {
            ...
            if (__classPrivateFieldGet(this, _WebSocketConnectionManager_ipAddress, "f") == newIpAddress) {
                _console$4.log(`redundnant ipAddress assignment "${newIpAddress}"`);
                return;
            }
            __classPrivateFieldSet(this, _WebSocketConnectionManager_ipAddress, newIpAddress, "f");
            _console$4.log(`updated ipAddress to "${this.ipAddress}"`);
        }
        get isSecure() {
        ...
        set isSecure(newIsSecure) {
            ...
            if (__classPrivateFieldGet(this, _WebSocketConnectionManager_isSecure, "f") == newIsSecure) {
                _console$4.log(`redundant isSecure assignment ${newIsSecure}`);
                return;
            }
            __classPrivateFieldSet(this, _WebSocketConnectionManager_isSecure, newIsSecure, "f");
            _console$4.log(`updated isSecure to "${this.isSecure}"`);
        }
        get url() {
        ...
        async connect() {
            ...
            try {
                ...
                _console$4.error("error connecting to webSocket", error);
                this.status = "notConnected";
            }
        }
        async disconnect() {
            await super.disconnect();
            _console$4.log("closing websocket");
        ...
        async sendSmpMessage(data) {
            super.sendSmpMessage(data);
            _console$4.error("smp not supported on webSockets");
        }
        async sendTxData(data) {
    ...
    _WebSocketConnectionManager_bluetoothId = new WeakMap(), _WebSocketConnectionManager_webSocket = new WeakMap(), _WebSocketConnectionManager_ipAddress = new WeakMap(), _WebSocketConnectionManager_isSecure = new WeakMap(), _WebSocketConnectionManager_boundWebSocketEventListeners = new WeakMap(), _WebSocketConnectionManager_pingTimer = new WeakMap(), _WebSocketConnectionManager_instances = new WeakSet(), _WebSocketConnectionManager_sendMessage = function _WebSocketConnectionManager_sendMessage(message) {
        this.assertIsConnected();
        _console$4.log("sending webSocket message", message);
        ...
        _console$4.log("webSocket.open", event);
        ...
        _console$4.log(`webSocket.message (${dataView.byteLength} bytes)`);
        ...
        _console$4.log(`received "${messageType}" message (${dataView.byteLength} bytes)`);
        switch (messageType) {
            case "ping":
    ...
    class Device {
        ...
        constructor() {
            ...
            this.addEventListener("getSensorConfiguration", () => {
                ...
                if (this.sensorTypes.includes("pressure")) {
                    _console$3.log("requesting required pressure information");
                    ...
                    _console$3.log("don't need to request pressure infomration");
                }
                if (this.sensorTypes.includes("camera")) {
                    _console$3.log("requesting required camera information");
                    const messages = RequiredCameraMessageTypes.map((messageType) => ({
                        type: messageType,
                    }));
                    this.sendTxMessages(messages, false);
                    ...
                    _console$3.log("don't need to request camera infomration");
                }
                if (this.sensorTypes.includes("microphone")) {
                    _console$3.log("requesting required microphone information");
                    const messages = RequiredMicrophoneMessageTypes.map((messageType) => ({
                        type: messageType,
                    }));
                    this.sendTxMessages(messages, false);
        ...
        async connect(options) {
            _console$3.log("connect options", options);
            if (options) {
                switch (options.type) {
                    case "webBluetooth":
            ...
            if (options?.type == "client") {
                _console$3.assertWithError(this.connectionType == "client", "expected clientConnectionManager");
                const clientConnectionManager = this
                    .connectionManager;
                clientConnectionManager.subType = options.subType;
                return clientConnectionManager.connect();
            }
            _console$3.log("connectionManager type", this.connectionManager.type);
        ...
        toggleConnection() {
            if (this.isConnected) {
                ...
                try {
                    ...
                    _console$3.error("error trying to reconnect", error);
                    this.connect();
                }
            }
            else {
        ...
        async sendFile(fileType, file) {
            _console$3.assertWithError(this.validFileTypes.includes(fileType), `invalid fileType ${fileType}`);
        ...
        async reset() {
            _console$3.assertWithError(this.canReset, "reset is not enabled for this device");
        ...
        set isServerSide(newIsServerSide) {
            if (__classPrivateFieldGet(this, _Device_isServerSide, "f") == newIsServerSide) {
                _console$3.log("redundant isServerSide assignment");
                return;
            }
            _console$3.log({ newIsServerSide });
        ...
        async reconnectViaWebSockets() {
            _console$3.assertWithError(this.isWifiConnected, "wifi is not connected");
            _console$3.assertWithError(this.connectionType != "webSocket", "already connected via webSockets");
            _console$3.assertTypeWithError(this.ipAddress, "string");
            _console$3.log("reconnecting via websockets...");
        ...
        async reconnectViaUDP() {
            _console$3.assertWithError(isInNode, "udp is only available in node");
            _console$3.assertWithError(this.isWifiConnected, "wifi is not connected");
            _console$3.assertWithError(this.connectionType != "udp", "already connected via udp");
            _console$3.assertTypeWithError(this.ipAddress, "string");
            _console$3.log("reconnecting via udp...");
            await this.disconnect();
            await this.connect({
                type: "udp",
                ipAddress: this.ipAddress,
    ...
    _a$1 = Device, _Device_eventDispatcher = new WeakMap(), _Device_connectionManager = new WeakMap(), _Device_isConnected = new WeakMap(), _Device_reconnectOnDisconnection = new WeakMap(), _Device_reconnectIntervalId = new WeakMap(), _Device_deviceInformationManager = new WeakMap(), _Device_batteryLevel = new WeakMap(), _Device_sensorConfigurationManager = new WeakMap(), _Device_clearSensorConfigurationOnLeave = new WeakMap(), _Device_sensorDataManager = new WeakMap(), _Device_vibrationManager = new WeakMap(), _Device_fileTransferManager = new WeakMap(), _Device_tfliteManager = new WeakMap(), _Device_firmwareManager = new WeakMap(), _Device_isServerSide = new WeakMap(), _Device_wifiManager = new WeakMap(), _Device_cameraManager = new WeakMap(), _Device_microphoneManager = new WeakMap(), _Device_displayManager = new WeakMap(), _Device_instances = new WeakSet(), _Device_DefaultConnectionManager = function _Device_DefaultConnectionManager() {
        ...
        _console$3.assertWithError(this.isConnected, "notConnected");
        ...
        return messageTypes.every((messageType) => {
            ...
            if (!hasConnectionMessage) {
                _console$3.log(`didn't receive "${messageType}" message`);
            }
        ...
        _console$3.log("requesting required information");
        ...
        _console$3.assertWithError(this.canUpdateFirmware, "can't update firmware");
        ...
        _console$3.assertWithError(this.hasCamera, "camera not available");
    }, _Device_assertHasMicrophone = function _Device_assertHasMicrophone() {
        _console$3.assertWithError(this.hasMicrophone, "microphone not available");
    }, _Device_assertWebAudioSupport = function _Device_assertWebAudioSupport() {
        _console$3.assertWithError(AudioContext, "WebAudio is not supported");
    }, _Device_assertDisplayIsAvailable = function _Device_assertDisplayIsAvailable() {
        _console$3.assertWithError(this.isDisplayAvailable, "display not available");
    };
    ...
    class DevicePair {
        ...
        assignDevice(device) {
            if (!__classPrivateFieldGet(this, _DevicePair_instances, "m", _DevicePair_isDeviceCorrectType).call(this, device)) {
                _console.log(`device is incorrect type ${device.type} for ${this.type} devicePair`);
                return;
            }
        ...
        static get insoles() {
            return __classPrivateFieldGet(this, _a, "f", _DevicePair_insoles);
        }
        static get gloves() {
            return __classPrivateFieldGet(this, _a, "f", _DevicePair_gloves);
        }
    }
    _a = DevicePair, _DevicePair_type = new WeakMap(), _DevicePair_eventDispatcher = new WeakMap(), _DevicePair_left = new WeakMap(), _DevicePair_right = new WeakMap(), _DevicePair_boundDeviceEventListeners = new WeakMap(), _DevicePair_sensorDataManager = new WeakMap(), _DevicePair_instances = new WeakSet(), _DevicePair_dispatchEvent_get = function _DevicePair_dispatchEvent_get() {
    ...
    _DevicePair_insoles = { value: new _a("insoles") };
    _DevicePair_gloves = { value: new _a("gloves") };
    (() => {
        DeviceManager$1.AddEventListener("deviceConnected", (event) => {
            const { device } = event.message;
            if (device.isInsole) {
                __classPrivateFieldGet(_a, _a, "f", _DevicePair_insoles).assignDevice(device);
            }
            if (device.isGlove) {
                __classPrivateFieldGet(_a, _a, "f", _DevicePair_gloves).assignDevice(device);
            }
        });
    })();
